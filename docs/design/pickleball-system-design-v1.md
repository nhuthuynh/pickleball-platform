...
| 9 | Competitions + social media advertising | **Existing + Flagged conflict.** §3.8 (competitions) exists conceptually (not built). §7 of the spec already addresses "social promotion" — see the **conflict in §4 below**, this is the important one. |
