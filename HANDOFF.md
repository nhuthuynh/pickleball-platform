...
**Retros: written and merged** — `docs/process/t56-retro.md`,
...
Ceremony 1 ran the new premise check and found **four of the five
caller-supplied ownership facts #149 names are no longer read from the wire
at all**, closed by T16.2 and T17.1 without the issue being updated. Only
`booking_host_id` survives, and it survives for a structural reason the
other four did not have — Payments has no port into Booking. See
`docs/process/t59-sprint-plan.md` §3; T59.2 corrects the issue itself.
