...
| T37 | `docs/process/t37-sprint-plan.md` (Ceremony 1 corrects `HANDOFF.md`'s T36 Docs-index row and Task-backlog narrative as its first job, re-runs the merged-fix issue sweep) | not yet written | not yet opened | — | — |
...
**T37 — Ceremony 1/2 only.** See `docs/process/t37-sprint-plan.md` for the
