...
| T51 | `docs/process/t51-sprint-plan.md` (Ceremony 1 corrects `HANDOFF.md`'s T50 Docs-index row and Task-backlog narrative as its first job, re-runs the merged-fix issue sweep) | not yet written | not yet opened | — | — |
